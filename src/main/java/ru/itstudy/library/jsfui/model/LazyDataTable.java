package ru.itstudy.library.jsfui.model;
...
import ru.itstudy.library.jsfui.controller.AbstractController;

import java.util.List;
import java.util.Map;

// модель постраничного вывода списка книг при любом поиске
